...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!WEBHOOK_URL) {
      console.error("[whatsapp-proxy] N8N_WHATSAPP_WEBHOOK_URL is not configured");
      return new Response(
    ...
    console.log("[whatsapp-proxy] Forwarding request to n8n...");
    ...
    console.log("[whatsapp-proxy] n8n response status:", response.status);
